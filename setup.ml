...
(* OASIS_START *)
(* DO NOT EDIT (digest: 528825af4ec24d760a7bfcece60fbb72) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources = ["spf_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [(OASISExpr.EBool true, ["-Wall"; "-Werror"])];
                      bs_cclib = [(OASISExpr.EBool true, ["-lspf2"])];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "spf"; FindlibPackage ("unix", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "l\127S\219G\255\166@D\022\189\180+\152\225\196";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
